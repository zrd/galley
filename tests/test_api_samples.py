...
class TestInputValidation:
    ...
    def test_create_sample_empty_title(
        self, client: TestClient, auth_headers: dict, manuscript_id: str
    ):
    ...
    def test_create_sample_missing_title(
        self, client: TestClient, auth_headers: dict, manuscript_id: str
    ):
    ...
    def test_create_sample_missing_excerpt_start(
        self, client: TestClient, auth_headers: dict, manuscript_id: str
    ):
        """Missing excerpt_start should be rejected."""
        response = client.post(
            f"/samples/manuscripts/{manuscript_id}/samples",
            headers=auth_headers,
            json={
    ...
    def test_create_sample_missing_excerpt_end(
        self, client: TestClient, auth_headers: dict, manuscript_id: str
    ):
        """Missing excerpt_end should be rejected."""
        response = client.post(
            f"/samples/manuscripts/{manuscript_id}/samples",
            headers=auth_headers,
            json={
